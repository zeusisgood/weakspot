...
- バージョンの方針（1.1.0 以降）:
  ...
  - 現行は 1.3.4。範囲は `WeakSpotMod.ACCEPTED_VERSIONS = "[1.3,1.4)"`（Maven のバージョン範囲の書式。Forge の `VersionRange`）。
