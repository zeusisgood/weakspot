...
- **[weakspot-1.9.1.jar をダウンロード](https://github.com/zeusisgood/weakspot/releases/download/v1.9.1/weakspot-1.9.1.jar)**（最新版 1.9.1。クリックで直接ダウンロード）
...
- **1.8.x とは接続不可**。サーバーと全員のクライアントを同時に更新
- サーバーの設定で、採掘・成長・機械・動物の弱点と、採掘のコンボ倍率をオフにできるように変更
- 内部構造を整理（通信の統合、古い互換処理の削除）。1.8.4 以前のガイドの本は、捨てて K キーの「ガイド」で読む
